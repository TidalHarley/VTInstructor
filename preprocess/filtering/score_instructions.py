...
使用方法：
    python preprocess/filtering/score_instructions.py
    python preprocess/filtering/score_instructions.py --api_key YOUR_KEY
    python preprocess/filtering/score_instructions.py --resume
    python preprocess/filtering/score_instructions.py --dry_run
    python preprocess/filtering/score_instructions.py --max_items 100
