#!/usr/bin/env python3
"""
SFT training script with VTMod (VP encoder + spatial adapter) on Qwen3-VL.
...
Usage:
    python -m torch.distributed.run --nproc_per_node=8 \
        ...
        --filtered_json /path/to/r2rce_train_filtered.json \
...
from vtmod.dataset import VPDataset, VPCollator
