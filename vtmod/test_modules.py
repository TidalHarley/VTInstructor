#!/usr/bin/env python3
"""
End-to-end test for VTMod (encoder, adapter, wrapper).
...
Run from the repo root:
    python vtmod/test_modules.py [--quick]
    # or: python -m vtmod.test_modules [--quick]
"""
import argparse
import os
import sys
...
from vtmod.encoder import VPEncoder, build_vp_encoder
from vtmod.adapter import VPSpatialAdapter, build_vp_adapters, _GATE_INIT
...
def main():
    ...
    print("=" * 60)
    print("VTMod (encoder / adapter / wrapper) test suite")
    print("=" * 60)
